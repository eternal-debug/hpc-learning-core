            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('admin.course-sub-category.index', $course_category->id) }}"
                ...
                <div class="card-body">
                    <form
                        action="{{ route('admin.course-sub-category.update', ['course_category' => $course_category->id, 'course_sub_category' => $course_sub_category->id]) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-input-block name="icon" placeholder="Enter category icon" :value="$course_sub_category->icon">
                                    <x-slot name="hint">
                            ...
                            <div class="col-md-12">
                                <x-input-block name="name" placeholder="Enter category name" :value="$course_sub_category->name" />
                            </div>
                            <div class="col-md-3">
